...
import {energyType, verificationType, publishType} from '@/utils/typeEnum'
...
export default {
    ...
    return {
      ...
      Vcolumns: [
        ...
        },
        {
          title: '核销状态',
          dataIndex: 'status',
          scopedSlots: { customRender: 'status', type: 'select', data: verificationType }
        }
      ]
    }
  },
  ...
  methods: {
    fetch(params, type) {
      const apiType = {
        P: 'assetSaleRecordList',
        V: 'verificationRecordList'
      }
