      ...
      <div class="header clearfix">
        ...
        <div class="setting">
          <router-link
            ...
            class="item"
          >
            <i class="iconfont iconjiaoyizhongxin" />
            交易中心
          </router-link>
      ...
      <div class="page-one">
        ...
        <div class="middle">
          ...
          <Map
            class="map-item"
            :chart-data="mapData"
            :proportion="middleData && middleData.proportion"
          />
        ...
        <div class="right">
          ...
          <div class="addup">
            <Title
              ...
              is-show-tri
              :is-up="isShowPageTwo"
              @click="isShowPageTwo = true"
            />

            <HorizontalBar
              id="addupBar"
              class="item addup-brabd"
              height="420px"
              bar-color="rgba(24, 234, 181, .8)"
              :chart-data="windCount"
            />
          </div>
        </div>
      </div>
        ...
        >
          <div class="inner">
            ...
            <div class="chart-body">
              <template v-for="(val, key) in addupCount">
                <SubTitle
                  :key="`${key}-title`"
                  :title="`${EnumMap(energyType, Number(key))}量`"
                />
                <div
                  :key="`${key}-chart`"
                  class="list"
...
.screen-wrap {
  ...
  .container {
    width: 100%;
    height: 100%;
    background: url(../../static/screen/bg.png) no-repeat top center;
    position: relative;
  }
