 ...
 * @param {integer} pageNum -起始页
 * @param {integer} pageSize -每页显示条数
 * @param {integer} orderId -查询订单明细 只需要传订单Id
 * @param {integer} assetSaleId -资产售卖id
 * @param {integer} projectId -订单详情
 * @param {string} projectName -项目名称
 * @param {integer} energyType -能源类型 0 光伏 1 风电 2 水电
 * @param {integer} orderStatus -订单状态
 * @param {string} tradeTimeStart -交易开始时间
 * @param {string} tradeTimeEnd -交易结束时间
 * @param {integer} userId -
 */
obj.orderDetail=function(params) {
  return request({
    url: '/api/trade/orderDetail',
    method: 'get',
    params,
    domain: 'wx'
  })
 ...
 * @param {integer} userId -
 */
obj.orderList=function(params) {
  return request({
    url: '/api/trade/orderList',
    method: 'get',
    params,
    domain: 'wx'
  })
 ...
 * 充值提现记录列表
 * @method
 * @name rechargeWithdrawList
 * @param {integer} id -id
 * @param {integer} pageNum -起始页
 * @param {integer} pageSize -每页显示条数
 * @param {string} verificationTimeStart -操作时间开始
 * @param {string} verificationTimeEnd -操作时间结束
 * @param {integer} status -状态：0失败 1成功 2交易中
 * @param {integer} type -类型：0充值 1提现
 * @param {integer} userId -
 */
obj.getCancelAfterVerification=function(params) {
  return request({
    url: '/api/cancelAfterVerification/getCancelAfterVerification',
    method: 'get',
    params,
    domain: 'wx'
  })
 ...
 * @param {integer} pageNum -起始页
 * @param {integer} pageSize -每页显示条数
 * @param {string} createTimeStart -操作时间开始
 * @param {string} createTimeEnd -操作时间结束
 * @param {integer} status -状态：0失败 1成功 2交易中
 * @param {integer} type -类型：0充值 1提现
 * @param {integer} userId -
 */
obj.rechargeWithdrawList=function(params) {
  return request({
    url: '/api/trade/rechargeWithdrawList',
    method: 'get',
    params,
    domain: 'wx'
  })
